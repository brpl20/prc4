class Work < ApplicationRecord
  ...
  validates :procedure_ids, :subject, :rate_work, :rate_parceled, :power_ids, presence: true
  validates :rate_parceled_exfield, presence: true, if: proc { |w| w.rate_parceled == 'Sim' }
